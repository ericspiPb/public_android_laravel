...
function artisan($arguments) {
	include_once $arguments[0].'/vendor/autoload.php';
	$app = include_once $arguments[0].'/bootstrap/app.php';
	$kernel = $app->make(Illuminate\Contracts\Console\Kernel::class);
	$status = $kernel->handle(
		$input = new Symfony\Component\Console\Input\ArgvInput,
		new Symfony\Component\Console\Output\ConsoleOutput
	);
	$kernel->call($arguments[1], array_slice($arguments, 2));
...
if (!empty($command)) {
    switch ($command[0]) {
        ...
        case 'install':
            ...
            exit;
        case 'artisan':
            artisan(empty($_GET['arg']) ? array() : $_GET['arg']);
        	exit;
    }
}
...
<body>
	...
	<div>
		...
		<p>
			...
			<a href="?composer&arg[]=install&arg[]=-d&arg[]=laravel/">?composer&amp;arg[]=install&amp;arg[]=-d&amp;arg[]=laravel/</a> - laravel install<br />
